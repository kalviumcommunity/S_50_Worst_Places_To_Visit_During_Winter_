...
</Link>        <button className="rounded border border-black text-white button mr-10 h-9 w-20">Sign up</button>
      </nav>
      
      <div className="bgimg border border-black h-72 flex items-center justify-center">
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-4 mt-4 w-96 mx-auto items-center justify-center">
        {data.map((entry) => (
